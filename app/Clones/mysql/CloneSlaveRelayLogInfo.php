...
class CloneSlaveRelayLogInfo
{
    public static $tableName = 'slave_relay_log_info';
    ...
    public function exec()
    {
        ...
        $records            = [];
        $columns            = ['Number_of_lines','Relay_log_name','Relay_log_pos','Master_log_name','Master_log_pos','Sql_delay','Number_of_workers','Id','Channel_name'];
