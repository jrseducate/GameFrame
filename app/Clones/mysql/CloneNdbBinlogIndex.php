...
class CloneNdbBinlogIndex
{
    public static $tableName = 'ndb_binlog_index';
    ...
    public function exec()
    {
        ...
        $records            = [];
        $columns            = ['Position','File','epoch','inserts','updates','deletes','schemaops','orig_server_id','orig_epoch','gci','next_position','next_file'];
